...
export default function Home() {
  const getArbPrice = async () => {
    ...
    setArbPrice(data.coins["arbitrum:0x912ce59144191c1204e64559fe8253a0e49e6548"].price);
  };
    ...
    <div className="bg-gray-100 py-12">
      <div className="px-4 sm:px-6 lg:px-8 container mx-auto">
        <div className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
          <dt className="truncate text-sm font-medium text-gray-500">Current ARB price</dt>
